...
QSqlQueryModel * employee::afficher(){
    ...
    model->setHeaderData(6,Qt::Horizontal,QObject::tr("diplomes"));
...
QSqlQueryModel* employee::RechercherEmploye(const QString &text)
{
    ...
    QString queryStr = QString("SELECT ID, NOM, PRENOM, MAIL, DATEEMBAUCHE, CERTIFICATS, SALAIRE, ASSURANCE, DIPLOMES, 'Modifier' AS Action, 'Supprimer' AS Action "
                               "FROM TABLE4 WHERE ID LIKE '%%1%' OR NOM LIKE '%%1%' OR PRENOM LIKE '%%1%' OR MAIL LIKE '%%1%' OR DATEEMBAUCHE LIKE '%%1%' OR CERTIFICATS LIKE '%%1%' OR SALAIRE LIKE '%%1%' OR ASSURANCE LIKE '%%1%' OR DIPLOMES LIKE '%%1%'")
    ...
    modal->setHeaderData(4, Qt::Horizontal, QObject::tr("Date d'Embauche"));
    modal->setHeaderData(5, Qt::Horizontal, QObject::tr("Certificats"));
    modal->setHeaderData(6, Qt::Horizontal, QObject::tr("Salaire"));
    modal->setHeaderData(7, Qt::Horizontal, QObject::tr("Assurance"));
    modal->setHeaderData(8, Qt::Horizontal, QObject::tr("Diplômes"));
